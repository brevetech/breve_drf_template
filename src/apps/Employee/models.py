...
class EmployeeModel(models.Model):
    ...
    address = models.TextField(
        null=True, verbose_name='Dirección', unique=True)
    dni = models.CharField(max_length=16, verbose_name='Cédula', unique=True)
    phone_number = models.CharField(
        max_length=25, verbose_name="Télefono", null=True)
    labor_specialty = models.CharField(
        max_length=50, verbose_name='Especialidad', null=True)
